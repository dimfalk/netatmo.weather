#' Polygon representation of municipalities in Germany (VG250 31.12.2021)
#'
#' A subset of data from the VG250_GEM product provided by the Federal Agency for Cartography and Geodesy, Germany
#'
#' @format Simple feature collection of type MULTIPOLYGON with 10,994 features and 1 field:
#' \describe{
...
#' @details: vg250_gem <- sf::st_read("VG250_GEM.shp") |> sf::st_filter(x = _, y = pk) |> dplyr::select("GEN") |> sf::st_transform("epsg:4326")
"vg250_gem"
