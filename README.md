...
#>  1 ok     2024-04-04 22:05:02 70:ee:50:0… Europe/… DE           111 Essen A 52  
#>  2 ok     2024-04-04 22:05:02 70:ee:50:6… Europe/… DE           112 Essen Steel…
#>  3 ok     2024-04-04 22:05:02 70:ee:50:0… Europe/… DE           114 Essen Steel…
#>  4 ok     2024-04-04 22:05:02 70:ee:50:a… Europe/… DE           108 Essen Eligi…
#>  5 ok     2024-04-04 22:05:02 70:ee:50:0… Europe/… DE            60 Essen Hengl…
#>  6 ok     2024-04-04 22:05:02 70:ee:50:1… Europe/… DE            79 Essen Am Kn…
#>  7 ok     2024-04-04 22:05:02 70:ee:50:a… Europe/… DE            69 Essen Notte…
#>  8 ok     2024-04-04 22:05:02 70:ee:50:0… Europe/… DE            69 Essen Notte…
#>  9 ok     2024-04-04 22:05:02 70:ee:50:5… Europe/… DE            76 Essen Lohdi…
#> 10 ok     2024-04-04 22:05:02 70:ee:50:a… Europe/… DE           101 Essen Bochu…
#> # ℹ 296 more rows
...
stations_tiled
#> Simple feature collection with 621 features and 13 fields
#> Geometry type: POINT
#> Dimension:     XY
#> Bounding box:  xmin: 6.890067 ymin: 51.34127 xmax: 7.129903 ymax: 51.52976
#> Geodetic CRS:  WGS 84
...
#>    status time_server         NAMain      timezone country altitude city  street
#>    <chr>  <dttm>              <chr>       <chr>    <chr>      <int> <chr> <chr> 
#>  1 ok     2024-04-04 22:05:59 70:ee:50:8… Europe/… DE            45 Essen Volck…
#>  2 ok     2024-04-04 22:05:59 70:ee:50:7… Europe/… DE            46 Essen Eva-H…
#>  3 ok     2024-04-04 22:05:59 70:ee:50:a… Europe/… DE            63 Essen Am Mö…
#>  4 ok     2024-04-04 22:05:59 70:ee:50:a… Europe/… DE            93 Essen Senge…
#>  5 ok     2024-04-04 22:05:59 70:ee:50:1… Europe/… DE            48 Essen Johan…
#>  6 ok     2024-04-04 22:05:59 70:ee:50:a… Europe/… DE            57 Essen Marti…
#>  7 ok     2024-04-04 22:05:59 70:ee:50:1… Europe/… DE            81 Essen Akade…
#>  8 ok     2024-04-04 22:05:59 70:ee:50:7… Europe/… DE            61 Essen Haupt…
#>  9 ok     2024-04-04 22:05:59 70:ee:50:7… Europe/… DE            61 Essen Haupt…
#> 10 ok     2024-04-04 22:05:59 70:ee:50:7… Europe/… DE            66 Essen Eiche…
#> # ℹ 611 more rows
#> # ℹ 6 more variables: mark <int>, n_modules <int>, NAModule1 <chr>,
#> #   NAModule2 <chr>, NAModule3 <chr>, geometry <POINT [°]>
```
...
# 5-minutely data
p1 <- get_period(res = 5)
as.POSIXct(p1, origin = "1970-01-01", tz = "UTC")
#> [1] "2024-04-01 08:40:00 UTC" "2024-04-04 22:00:00 UTC"
...
as.POSIXct(p3, origin = "1970-01-01", tz = "UTC")
#> [1] "2024-04-03 22:00:00 UTC" "2024-04-04 22:00:00 UTC"

# self-defined period
p4 <- get_period(c("2024-03-01", "2024-04-01"))
as.POSIXct(p4, origin = "1970-01-01", tz = "UTC")
...
#> 2024-02-22 07:00:00         9.9
#> 2024-02-22 08:00:00        10.8
#> 2024-02-22 09:00:00        11.4
#> 2024-02-22 10:00:00        12.4
#> 2024-02-22 11:00:00        13.6
